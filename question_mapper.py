def column_mapper(column_string):
    mapper= {
        ...
        "If you are admitted to 10 Academy's Batch 5 intensive training, are you able to commit full-time (~60 hours/week) without conflicting obligations?":"commitment",
        ...
        "Please confirm that you have read and are in agreement with the costs and pay-it-forward model for 10 Academy Batch 5 ":"pay_it_forward",
        ...
        "What is your highest completed level of Education (as on 31 Mar 2022)?":"highest_completed_level_of_Education",
        """When is your graduation date? Put your expected graduation date if you are still studying (Note: Applicants whose graduation date is between 1 Jan 2020 and 30 April 2022 are likely to be prioritized - a proof will be asked for at a later stage of the process)""":"graduation_date",
        "LinkedIn Profile Link":"linkedIn_profile",
        
        "Why do you want to join 10 Academy Batch 5 Intensive Training? Help our team to understand your past work, your future goals and how your taking up 10 Academy training will help you (and those around you) to grow. (1500 characters max)":"reason_to_join",
        ...
        "How many months of full-time work experience do you have as of 31 Mar 2022?":"work_experience_month",
        "Batch":"batch",
